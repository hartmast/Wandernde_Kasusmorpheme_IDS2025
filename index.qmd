...
w %>% filter(Number=="sg" & Gender %in% c("m", "n") & klasse=="nicht_schwach" & position != "both") %>% mutate(s_los = ifelse(x_less=="y", "ja", "nein")) qbarplot(cxn, s_less, Position, wrap100 = T) + scale_fill_brewer(palette = "Oranges") +
